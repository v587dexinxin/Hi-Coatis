...
##The normalization method for peak intensity across different cell numbers can be found in the computeMatrix_normalize.py file in the scripts folder.
...
##The normalization method for peak intensity across different datasets can be found in the computeMatrix_normalize.py file in the scripts folder.
