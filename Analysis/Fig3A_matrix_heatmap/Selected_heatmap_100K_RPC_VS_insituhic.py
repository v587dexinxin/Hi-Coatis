# -*- coding: utf-8 -*-
"""
Created on Wed Oct 18 22:09:08 2023

@author: lenovo
"""

"""
Created on Tue Oct 17 20:35:59 2023
...
####matrix#######
c_rpc = cooler.Cooler("/scratch/2024-10-21/bio-shenw/Ljniu/K562/matrix/cool/K562_RPC_0.1FA/Combined_562_0.1FA_merged5_.hg38.mapq_30.1000.mcool::/resolutions/100000")
c_chiapet = cooler.Cooler("/scratch/2024-10-21/bio-shenw/Ljniu/K562/matrix/cool/K562_in_situHiC/K562_in_situHiC_balanced.mcool::/resolutions/100000")
...
#####Out_Files#####
OutFolder = '/scratch/2024-10-21/bio-shenw/Ljniu/K562/plots/Fig1_K562_0.1FA_hic_heatmap/RPC_VS_insituHiC'
OutFil = 'Selected_K562_0.1FA_VS_insituHiC_heatmap_100K_chr11_55_110M.pdf'
pp = PdfPages(os.path.join(OutFolder , OutFil))


####interval#####

interval = [('chr11' , 55000000 , 110000000)]
interval_1 = [('chr11' , 55200000 , 65000000)]
...
ax.set_ylabel('insituHiC_Chr11' , fontsize=20)
ax.yaxis.set_label_position("right")
# ax.set_xlim(0, matrix.shape[1])
# ax.set_ylim(0, matrix.shape[0])
ax.set_title('K562_0.1FA_VS_insituHiC_heatmap_100K_chr11_55_110M' , fontsize=25)
