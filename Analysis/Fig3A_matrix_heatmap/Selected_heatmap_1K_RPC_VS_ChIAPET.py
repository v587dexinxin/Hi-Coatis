...
c_chiapet = cooler.Cooler("/scratch/2024-10-21/bio-shenw/Ljniu/K562/matrix/cool/K562_RNAPII_chiaPET/K562_RNAPII_ChIA-PET_hg38_ENCFF582UXM.mcool::/resolutions/1000")
...
OutFil = 'Selected_K562_0.1FA_VS_RNAPII_chiapet_heatmap_1K_' + interval[0][0] + '_' + str(interval[0][1] // 1000000) + '_' + str(interval[0][2] // 1000000) + 'M.pdf'
...
ax.set_title('K562_0.1FA_VS_RNAPolII_ChIAPET_heatmap_1K_' + interval[0][0] + '_' + str(interval[0][1] // 1000000) + '_' + str(interval[0][2] // 1000000) + 'M' , fontsize=25)
