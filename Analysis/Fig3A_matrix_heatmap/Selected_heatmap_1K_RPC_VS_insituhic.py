...
####matrix#######
c_rpc = cooler.Cooler("/scratch/2024-10-21/bio-shenw/Ljniu/K562/matrix/cool/K562_RPC_0.1FA/Combined_562_0.1FA_merged5_.hg38.mapq_30.1000.mcool::/resolutions/1000")
c_chiapet = cooler.Cooler("/scratch/2024-10-21/bio-shenw/Ljniu/K562/matrix/cool/K562_in_situHiC/K562_in_situHiC_balanced.mcool::/resolutions/1000")
...
OutFil = 'Selected_K562_0.1FA_VS_insituHiC_heatmap_1K_' + interval[0][0] + '_' + str(interval[0][1] // 1000000) + '_' + str(interval[0][2] // 1000000) + 'M.pdf'
...
ax.set_title('K562_0.1FA_VS_insituHiC_heatmap_1K_' + interval[0][0] + '_' + str(interval[0][1] // 1000000) + '_' + str(interval[0][2] // 1000000) + 'M' , fontsize=25)
